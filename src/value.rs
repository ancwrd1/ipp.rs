    ...
    fn test_collection_de_serialize() {
        let attr = IppAttribute::new(
            ...
            IppValue::Collection(vec![
                IppValue::Integer(0x11111111),
                IppValue::Integer(0x22222222),
            ]),
        );
        let mut buf = Vec::new();
        ...
        assert_eq!(
            vec![
                0x34, 0, 4, b'c', b'o', b'l', b'l', 0, 0, 0x21, 0, 0, 0, 4, 0x11, 0x11, 0x11, 0x11,
                0x21, 0, 0, 0, 4, 0x22, 0x22, 0x22, 0x22, 0x37, 0, 0, 0, 0,
            ],
            buf
        );
        ...
        let attrs = res.attributes().get_printer_attributes().unwrap();
